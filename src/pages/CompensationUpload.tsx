    ...
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      >
        <div className="p-6 md:p-10 max-w-3xl mx-auto animate-scale-in">
          <div className="mb-8">
            <h1 className="heading-xl">Import de Compensation</h1>
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div 
                    className={`border-2 border-dashed rounded-lg p-6 text-center hover:bg-secondary/50 transition-colors cursor-pointer ${
                ...
                {filePreview && (
                  <div className="border rounded-lg p-3 bg-secondary/30">
                    ...
                    <pre className="text-xs overflow-x-auto whitespace-pre-wrap bg-background p-2 rounded">
                      {filePreview}
                    </pre>
                  </div>
                )}
