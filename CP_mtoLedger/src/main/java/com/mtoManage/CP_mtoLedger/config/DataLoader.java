...
public class DataLoader implements CommandLineRunner {
    ...
    @Autowired
    private TresoTransactionRepository tresoTransactionsRepository;
    ...
    private void loadProducts() {
        ...
        TresoProduct UAEExchange = new TresoProduct();
        UAEExchange.setProductId(4);
        UAEExchange.setProductName("UAE Exchange"); 
        UAEExchange.setActive(1);

        TresoProduct remitly = new TresoProduct();
        remitly.setProductId(5);
        remitly.setProductName("Remitly");
        remitly.setActive(1);

        TresoProduct worldRemit = new TresoProduct();
        worldRemit.setProductId(6);
        worldRemit.setProductName("WorldRemit");
        worldRemit.setActive(1);

        TresoProduct sendFriend = new TresoProduct();
        sendFriend.setProductId(7);
        sendFriend.setProductName("SendFriend");
        sendFriend.setActive(1);

        TresoProduct sendWave = new TresoProduct();
        sendWave.setProductId(8);
        sendWave.setProductName("SendWave");
        sendWave.setActive(1);
        
        TresoProduct sendMoney = new TresoProduct();
        sendMoney.setProductId(9);
        sendMoney.setProductName("SendMoney");
        sendMoney.setActive(1);

        tresoProductRepository.saveAll(Arrays.asList(westernUnion, moneyGram, ria, UAEExchange, remitly, worldRemit, sendFriend, sendWave, sendMoney));

        TresoCommission commissionMoneyGram = new TresoCommission();
        commissionMoneyGram.setTauxCommission(new BigDecimal("1.2"));
        ...
        commissionRia.setTauxCommission(new BigDecimal("0.9"));
        ...
        commissionWesternUnion.setTauxCommission(new BigDecimal("1.3"));
