...
public class AdjustmentScheduler {
    ...
    private final TresoSchedulerRepository tresoSchedulerRepository;
    ...
    public void processAdjustments() {
        ...
        try {
            ...
            tresoMessage.setMessage("<i style=\"color:green\" class=\"fa fa-check-circle\"></i> Adjustments for "+LocalDate.now()+" were completed successfully");
            ...
            tresoScheduler.setSchedulerName("Adjustment Scheduler");
            tresoScheduler.setState(1);

            tresoSchedulerRepository.save(tresoScheduler);
            ...
            tresoScheduler.setErrorDesc(e.getMessage());
            tresoScheduler.setErrorDetail(Arrays.toString(e.getStackTrace()));
