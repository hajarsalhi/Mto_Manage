...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadProducts() {
        ...
        westernUnion.setProductType("MTO");
        westernUnion.setActive(true);
        ...
        moneyGram.setProductType("MTO");
        moneyGram.setActive(true);
        moneyGram.setCommissionRate(new BigDecimal("1.2"));
        moneyGram.setCurrency("EUR");
        
        TresoProduct ria = new TresoProduct();
        ria.setProductId(3);
        ria.setProductName("Ria");
        ria.setProductType("MTO");
        ria.setActive(true);
        ria.setCommissionRate(new BigDecimal("1.3"));
        ria.setCurrency("USD");
