...
public class ProductServiceImpl implements ProductService {
    ...
    public void updateProduct(Integer id, ProductFinParams product) {
        ...
        //update product and create a new commission
        TresoProduct tresoProduct = productRepository.findById(id).orElseThrow();
        ...
        tresoProduct.setEmail(product.getEmails());
        ...
        tresoCommission.setProduct(tresoProduct);
        ...
        tresoProduct.getCommissions().add(tresoCommission);

        productRepository.save(tresoProduct);
        commissionRepository.save(tresoCommission);


        // Keep a trace of changes into TresoProductInfoChanges
        TresoProductInfoChanges productInfoChanges = new TresoProductInfoChanges();
        productInfoChanges.setProductId(tresoProduct.getProductId());
