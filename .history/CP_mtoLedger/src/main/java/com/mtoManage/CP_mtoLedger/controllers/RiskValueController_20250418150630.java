...
public class RiskValueController {
    ...
    private final RiskValueServiceImpl riskValueService ;

    @Autowired
    public RiskValueController(RiskValueServiceImpl riskValueService) {
        this.riskValueService = riskValueService;
    }
