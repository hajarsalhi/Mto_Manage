...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadRiskValues() {
        ...
        wuRisk.setEndDate(LocalDate.of(2025,03,21)); // No end date means it's currently active
        ...
        mgRisk.setEndDate(LocalDate.of(2025,03,21));
        ...
        riaRisk.setEndDate(LocalDate.of(2025,03,21));
