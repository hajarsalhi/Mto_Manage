...
public class ReconciliationReportService {
    ...
    public boolean checkSchedulerState(String schedulerName, int daysAgo) {
        ...
        LocalDateTime nextDay = checkDate.plusDays(1).atStartOfDay();
        return schedulerRepository.existsByDateTimeAndNameAndState(startOfDay, nextDay, schedulerName, 1);
    }
    ...
    public void generateAndSendReport(TresoProduct product) throws IOException, MessagingException {
        ...
        try (BufferedWriter writer = Files.newBufferedWriter(filePath)) {
            ...
            String[] toEmails = product.getReconciliationEmails().split(",");
            emailService.sendEmailWithAttachment(
                toEmails,
                configParams.getMailCcTeam().split(","),
