...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadRiskValues() {
        ...
        wuRisk.setDateEnd(LocalDateTime.of(2025,03,21, 11, 15, 0, 0)); // No end date means it's currently active
        ...
        mgRisk.setDateEnd(LocalDateTime.of(2025,03,21, 11, 15, 0, 0)); // No end date means it's currently active
