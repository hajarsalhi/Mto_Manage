...
public class ProductServiceImpl implements ProductService {
    ...
    public void updateProduct(Integer id, ProductFinParams product) {
        ...
        if (originalProduct.getCommissions() != null && !originalProduct.getCommissions().isEmpty()) {
            ...
            if (!oldCommission.getTauxCommission().equals(product.getTauxCommission())) {
        ...
        if (originalProduct.getActive() != product.getActive()) {
        ...
        if (!originalProduct.getProductDeviseFx().equals(product.getDevise())) {
        ...
        if (!originalProduct.getApplyHour().equals(product.getApplyHour())) {
        ...
        if (!originalProduct.getDecote().equals(product.getDecote())) {
        ...
        if (!originalProduct.getEmail().equals(product.getEmails())) {
            ...
            emailChange.setDataAfter(product.getEmails());
            productInfoChangesRepository.save(emailChange);
        }
        
        if (!originalProduct.getEmailReconciliation().equals(product.getReconciliationEmails())) {
        ...
        if (!originalProduct.getSendReconciliationFile().equals(product.getSendReconciliationReports())) {
        ...
        originalProduct.setEmail(product.getEmails());
