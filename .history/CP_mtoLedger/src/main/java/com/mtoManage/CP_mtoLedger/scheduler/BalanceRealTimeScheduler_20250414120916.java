...
public class BalanceRealTimeScheduler {
    ...
    private final TresoNotificationRepository notificationRepository;
    ...
    public void setBalanceRealTime() {
        ...
        try {
            ...
            List<Integer> bankDepositProducts = partnerProductRepository.findBankDepositProducts();
    ...
    private void processPartnerXTransactions(LocalDateTime lastTransactionDate, List<Integer> bankDepositProducts) {
        ...
        for (PartnerX transaction : partnerTransactions) {
            TresoTransaction tresoTransaction = new TresoTransaction();
            ...
            tresoTransaction.setProductName(transaction.getProductName());
    ...
    private void updateBalances(List<TresoProduct> products, LocalDateTime lastTransactionDate) {
        for (TresoProduct product : products) {
            try {
                ...
                // Get commission rate
                BigDecimal commissionRate = commissionRepository.findCommissionRate(product.getProductId())
