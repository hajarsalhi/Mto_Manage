...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadRiskValues() {
        ...
        wuRisk.setDateEnd(LocalDateTime.of(2025,03,21)); // No end date means it's currently active
        ...
        mgRisk.setDateEnd(LocalDateTime.of(2025,03,22)); // No end date means it's currently active
        ...
        riaRisk.setDateEnd(LocalDateTime.of(2025,03,23 )); // No end date means it's currently active
