...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadRiskValues() {
        ...
        wuRisk.setDateStart(LocalDate.now().minusMonths(1));
        wuRisk.setDateEnd(LocalDate.of(2025,03,21)); // No end date means it's currently active
        
        TresoRiskValue mgRisk = new TresoRiskValue();
        mgRisk.setProductId(2);
        mgRisk.setRiskValue(new BigDecimal("300000"));
        mgRisk.setDateStart(LocalDate.now().minusMonths(1));
        mgRisk.setDateEnd(LocalDate.of(2025,03,22)); // No end date means it's currently active
        
        TresoRiskValue riaRisk = new TresoRiskValue();
        riaRisk.setProductId(3);
        riaRisk.setRiskValue(new BigDecimal("200000"));
        riaRisk.setDateStart(LocalDate.now().minusMonths(1));
        riaRisk.setDateEnd(LocalDate.of(2025,03,23 )); // No end date means it's currently active
