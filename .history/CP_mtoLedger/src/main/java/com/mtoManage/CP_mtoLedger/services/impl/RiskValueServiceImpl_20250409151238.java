...
public class RiskValueServiceImpl {
    ...
    public String calculStateRiskValue(LocalDateTime dateStart , LocalDateTime dateEnd) {
            ...
            if (dateStart.isAfter(LocalDateTime.now()) && dateEnd.isAfter(LocalDateTime.now())) {
                return "Pending";
            } else if((dateStart.isEqual(LocalDateTime.now()) && dateEnd.isEqual(LocalDateTime.now()) )|| (dateStart.isAfter(LocalDateTime.now()) || dateStart.isBefore(LocalDateTime.now())) && dateEnd.isAfter(LocalDateTime.now()))) {
                return "Active";
