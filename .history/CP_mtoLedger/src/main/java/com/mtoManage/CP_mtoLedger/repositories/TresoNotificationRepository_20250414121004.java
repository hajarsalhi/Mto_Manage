...
import com.mtoManage.CP_mtoLedger.models.TresoNotification;
...
@Repository
public interface TresoNotificationRepository extends JpaRepository<TresoNotification, Integer> {
