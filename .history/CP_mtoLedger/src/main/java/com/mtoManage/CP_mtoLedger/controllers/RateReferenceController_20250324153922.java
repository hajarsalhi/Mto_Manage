...
public class RateReferenceController {
    ...
    @PostMapping("/update")
    public ResponseEntity<?> updateRateReference(@RequestParam String currency , @RequestParam Float rate) {
        try {

            rateReferenceServiceImpl.updateRateReference(currency, rate);
