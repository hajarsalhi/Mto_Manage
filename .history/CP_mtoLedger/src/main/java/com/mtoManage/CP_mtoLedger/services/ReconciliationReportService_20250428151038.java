...
public class ReconciliationReportService {
    ...
    private final TresoCurrentBalanceRepository balanceRepository;
    ...
    public void generateAndSendReport(Product product) throws IOException {
        ...
        Path reportDir = Paths.get("cashplus_files/cp_data/recon_mto/recon_reports_" + product.getId());
        Files.createDirectories(reportDir);
        
        Path filePath = reportDir.resolve(fileShortName);
        String s3FilePath = "recon_mto/recon_reports_" + product.getId() + "/" + fileShortName;
