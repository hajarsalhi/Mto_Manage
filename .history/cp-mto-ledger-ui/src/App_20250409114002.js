...
import RecentBalances from './pages/BalanceMTO/RecentBalances.tsx';
            ...
            <div className="flex h-screen">
              ...
              <main className="flex-1 overflow-auto p-4">
                <Routes>
                  ...
                  <Route path="/balance/recent" element={<RecentBalances />} />
                  ...
                  <Route path="/reports" element={<Navigate to="/reports/compensations" replace />} />
