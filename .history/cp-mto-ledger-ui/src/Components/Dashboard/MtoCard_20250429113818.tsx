...
export function MtoCard({ 
  ...
  return (
    <Card className={cn(
      "overflow-hidden transition-all duration-200 hover:shadow-soft animate-fade-in card-shine border-2 border-grey-500",
      status.toLowerCase() === 'inactive' && "border-grey-50"
    )}>
