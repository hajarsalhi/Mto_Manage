...
const sampleCompensations: Record<string, Compensation[]> = {
  "1": [
    { id: "c1", date: "2023-10-15", amount: 1250, rate: 0.5, volume: 25000, status: "validated" },
    { id: "c2", date: "2023-09-15", amount: 1150, rate: 0.5, volume: 23000, status: "validated" },
    { id: "c3", date: "2023-08-15", amount: 1050, rate: 0.5, volume: 21000, status: "validated" },
  ],
  "2": [
    { id: "c4", date: "2023-10-15", amount: 750, rate: 0.3, volume: 25000, status: "validated" },
    { id: "c5", date: "2023-09-15", amount: 720, rate: 0.3, volume: 24000, status: "validated" },
  ],
  "3": [
    { id: "c6", date: "2023-10-15", amount: 500, rate: 0.2, volume: 25000, status: "validated" },
    { id: "c7", date: "2023-09-15", amount: 480, rate: 0.2, volume: 24000, status: "validated" },
  ],
  "4": [
    { id: "c8", date: "2023-10-15", amount: 375, rate: 0.15, volume: 25000, status: "pending" },
    { id: "c9", date: "2023-09-15", amount: 360, rate: 0.15, volume: 24000, status: "validated" },
  ],
  "5": [
    { id: "c10", date: "2023-09-15", amount: 600, rate: 0.25, volume: 24000, status: "validated" },
    { id: "c11", date: "2023-08-15", amount: 575, rate: 0.25, volume: 23000, status: "pending" },
  ],
  "6": [
    { id: "c12", date: "2023-10-15", amount: 875, rate: 0.35, volume: 25000, status: "pending" },
    { id: "c13", date: "2023-09-15", amount: 840, rate: 0.35, volume: 24000, status: "validated" },
  ],
};
...
function useffect(arg0: () => void, arg1: number[]) {
