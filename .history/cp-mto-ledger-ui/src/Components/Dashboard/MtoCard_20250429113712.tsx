...
export function MtoCard({ 
  ...
  return (
    <Card className={cn(
      "overflow-hidden transition-all duration-200 hover:shadow-soft animate-fade-in card-shine border-4 border-grey-100",
      status.toLowerCase() === 'inactive' && "border-4 border-grey-100"
    )}>
