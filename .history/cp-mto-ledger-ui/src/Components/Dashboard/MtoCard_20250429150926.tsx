        ...
        <div className="flex space-x-1">
          <DropdownMenu >
            ...
            <DropdownMenuContent className="w-56">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={()=> onViewMto(id)}>Edit Risk Value</DropdownMenuItem>
              <DropdownMenuItem onClick={handleViewTransANDComp}>View Latest Transactions & Compensations</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
      </CardHeader>
