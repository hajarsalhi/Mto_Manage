...
export function MtoDetails({ mtoId, mtoName, open, onClose }: MtoDetailsProps) {
  ...
  const [sampleTransactions, setSampleTransactions] = useState<{[key: number]: Transaction[]}>({});
  const [sampleCompensations, setSampleCompensations] = useState<{[key: number]: Compensation[]}>({});
