...
const RiskValue: React.FC = () => {
  ...
  const handleAddRiskValue = () => {
    navigate('/risk-value/add?id=' +selectedProductId );
  };
            ...
            { Array.isArray(activeRiskValues) && activeRiskValues?.length === 0 ? (
              ...
              <div className="bg-white shadow-md rounded-lg overflow-hidden">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className='bold-font'>MTO</TableHead>
                      <TableHead className='bold-font'>Date Start</TableHead>
                      <TableHead className='bold-font'>Date End</TableHead>
                      <TableHead className="text-right font-bold">Risk Value</TableHead>
                      <TableHead className='bold-font'>Created By</TableHead>
                      <TableHead className='bold-font'>Date Creation</TableHead>
                      <TableHead className='bold-font'>State</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
