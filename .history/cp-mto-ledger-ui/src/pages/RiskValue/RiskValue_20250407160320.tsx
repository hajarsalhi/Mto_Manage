...
const RiskValue: React.FC = () => {
  ...
  const activeRiskValues = filteredRiskValues?.filter(rv => getStateText(rv.dateEnd , rv.dateStart )=== 'Active');
  const historyRiskValues = filteredRiskValues?.filter(rv => getStateText(rv.dateEnd, rv.dateStart) !== 'Active');
