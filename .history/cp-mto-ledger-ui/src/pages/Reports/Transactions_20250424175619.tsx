...
const TransactionsReport = () => {
  ...
  const handleDownloadPDF = async () => {
    try {
        ...
        const response = await axios.get('/api/reports/transactions/pdf', {
          params: { 
            startDate, 
            endDate, 
            search: searchTerm,
        ...
        link.href = url;
        link.setAttribute('download', `transactions_report_${format(new Date(), 'yyyyMMdd')}.pdf`);
  ...
  const handleDownloadCSV = async () => {
    try {
      setDownloading(true);
      // Replace with your actual API endpoint
      const response = await axios.get('/api/reports/transactions/csv', {
        params: { 
          startDate, 
          endDate, 
          search: searchTerm,
