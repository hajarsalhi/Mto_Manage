      ...
      try {
        ...
        const mockData: ProductData = {
          ...
          fxRateParams: {
            ...
            fxEmails: 'fx@westernunion.com, treasury@westernunion.com'
          },
          reconciliation: {
            sendReport: true,
            emails: 'reconciliation@westernunion.com, finance@westernunion.com'
          }
        };
        
        setProduct(mockData);
        setCommissionRate(mockData.commissionRate.toString());
        setCurrency(mockData.fxRateParams.currency);
        setDiscount(mockData.fxRateParams.discount.toString());
        setNotificationMethod(mockData.fxRateParams.notificationMethod);
        setNotificationTime(mockData.fxRateParams.notificationTime);
        setFxEmails(mockData.fxRateParams.fxEmails);
        setSendReport(mockData.reconciliation.sendReport);
        setReconciliationEmails(mockData.reconciliation.emails);
        setActive(mockData.active);
      } finally {
        setLoading(false);
      }
    };
