...
import { createProduct, getNewProducts, updateProdctFinParams } from '../../services/product.service.ts';
import { ProductParams } from './ProductParams.tsx';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedProduct = {
        ...
        email: fxEmails,
        sendReconciliationReports: sendReport ,
            ...
            <div className="mb-6">
              ...
              >
                ...
                {Array.isArray(products) && products?.map(product => (
                  <option key={product.id} value={product.id} onClick={() => setProduct(product)}>
                    {product.name}
                  </option>
                ))}
              </select>
