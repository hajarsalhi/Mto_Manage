  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await axios.get('/api/products/without-commission');
        ...
        const mockProducts = [
          { id: 1, name: 'Western Union', hasCommissionRate: false },
          { id: 2, name: 'MoneyGram', hasCommissionRate: false },
          { id: 3, name: 'Ria', hasCommissionRate: false },
          { id: 4, name: 'UAE Exchange', hasCommissionRate: false }
        ];
