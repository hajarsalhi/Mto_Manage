...
import { getProductFinParamsById } from '../../services/product.service.ts';
    ...
    const fetchProductData = async () => {
      try {
        ...
        const mockData: ProductData = {
          ...
          prevTauxCommission: 1.5,
          tauxCommission: 0.0,
          active: 1,
          applyHour : '12:00',
          
          emails: 'fx@westernunion.com, treasury@westernunion.com',
          decote: 0.5,
          devise : 'USD',
          libDecote: 'Discount',
          productsMethod: 'Aucune',
          sendReconciliationReports: 1,
          reconciliationEmails: 'reconciliation@westernunion.com, finance@westernunion.com'
        ...
        setNotificationMethod(mockData.productsMethod);
        setNotificationTime(mockData.applyHour);
        setFxEmails(mockData.emails);
        setSendReport(mockData.sendReconciliationReports === 1);
        setReconciliationEmails(mockData.reconciliationEmails);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  value={`${product?.tauxCommission.toFixed(2)}%`}
                  disabled
                />
              </div>
              <div>
