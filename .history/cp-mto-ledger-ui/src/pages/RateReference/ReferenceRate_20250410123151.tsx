...
const ReferenceRate: React.FC = () => {
  ...
  const getPreviousRate = (devise : string)=> {
    ...
    return previousRate ? previousRate.fcoursVirement : undefined;
  }
                ...
                <TableRow key={rate.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end gap-2">
                      <span className={getRateChangeClass(rate.fcoursVirement, getPreviousRate(rate.devise))}>
                        {formatCurrency(rate.fcoursVirement)}
                      </span>
                      {getRateChangeIcon(rate.fcoursVirement, getPreviousRate(rate.devise))}
                    </div>
                  </TableCell>
                </TableRow>
              ))}
