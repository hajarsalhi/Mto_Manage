          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className='bold-font'>Date</TableHead>
                <TableHead className='bold-font'>MTO's Name</TableHead>
                <TableHead className='font-bold'>Reference</TableHead>
                <TableHead className="text-right font-bold">Amount</TableHead>
                <TableHead className="text-right font bold">FX Rate</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
