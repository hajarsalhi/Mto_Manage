              ...
              {realTimeBalanceData.length === 0 ? (
                ...
                realTimeBalanceData.map((balance) => (
                  ...
                  <TableRow key={balance.productId}>
                    ...
                    <TableCell className="text-right">{formatCurrency(dayBeforeBalance.balanceJ_1)}</TableCell>
                    <TableCell className="text-right text-green-600 font-medium">
                      {formatCurrency(dayBeforeBalance.compensationJ_1)}
                    </TableCell>
                    <TableCell className="text-right text-red-600 font-medium">
                      {formatCurrency(dayBeforeBalance.transactionJ_1)}
                    </TableCell>
