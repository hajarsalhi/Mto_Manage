...
const BalanceMto: React.FC = () => {
  ...
  const filteredBalances = realTimeBalanceData.filter((balance) =>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className='font-bold'>MTO Name</TableHead>
                <TableHead className="text-right font-bold">RealTime Balance</TableHead>
                <TableHead className="text-right font-bold">Balance J-1</TableHead>
                <TableHead className="text-right font-bold">Compensations J-1</TableHead>
                <TableHead className="text-right font-bold">Transactions J-1</TableHead>
